...
class AMOSMasterController:
    ...
    def show_architecture(self):
        ...
        print()
        print("=" * 70)
        print(f"Total Components: {len(set(c for v in self.VERSIONS.values() for c in v['components']))}")
        print("=" * 70)
        print()
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='AMOS Master Controller - All Versions'
    )
    parser.add_argument(
        '--version', '-v',
