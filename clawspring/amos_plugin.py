...
class AMOSPlugin:
    ...
    def _register_hooks(self) -> None:
        ...
        try:
            ...
            from clawspring.hooks import register_pre_tool_hook, register_post_tool_hook
    ...
    def _pre_tool_validation(self, tool_name: str, arguments: dict[str, Any]) -> dict[str, Any] | None:
        """
        ...
        if is_high_risk:
            ...
            print(f"[AMOS/L2] Consider both supporting and alternative cases")
        ...
        decision = ToolDecision(
            ...
            tool_name=tool_name,
            arguments=arguments,
            reasoning_chain=["L1 scope check passed", "L2 risk assessment" if is_high_risk else "Low risk"],
            law_violations=[],
            approved=permitted,
        )
