...
class SystemHealthValidator:
    ...
    def run_full_validation(self) -> dict[str, Any]:
        ...
        print("Target: All 30 modules + integrations\n")
    ...
    def _validate_phase(self, phase_name: str, checks: list[tuple[str, callable]]) -> None:
        ...
        for name, check_fn in checks:
            ...
            try:
                ...
                self.results.append(
                    HealthCheckResult(component=name, status=status, load_time_ms=duration)
                )
                ...
                self.results.append(
                    HealthCheckResult(
                        component=name, status="unhealthy", load_time_ms=duration, error=str(e)
                    )
                )
