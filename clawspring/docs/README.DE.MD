Deutsch | [English](../README.md) | [中文](README.CN.MD) | [Français](README.FR.MD) | [한국어](README.KO.MD) | [日本語](README.JP.MD) | [Português](README.ES.MD)
...
<h1 align="center" style="font-size: 30px;"><strong><em>ClawSpring</em></strong>: AMOS-Projekt - Ein schneller, einfacher KI-Assistent</h1>
<p align="center">
    <a href="https://github.com/trangyp/AMOS-Code/issues">Issues</a>
    ·
    <a href="https://github.com/trangyp/AMOS-Code/blob/main/clawspring/README.md">Dokumentation</a>
  </p>
</div>
...
- 01. Apr 2026, 08:23: Erste Version von ClawSpring veröffentlicht.

---

# ClawSpring

ClawSpring ist eine **leichte** und **einfach zu nutzende** Python-Neuimplementierung von Claude Code, die **jedes Modell** unterstützt, darunter Claude, GPT, Gemini, Kimi, Qwen, Zhipu, DeepSeek sowie lokale Open-Source-Modelle über Ollama oder beliebige OpenAI-kompatible Endpunkte.

---

## Inhalt
- [Warum ClawSpring](#warum-nano-claude-code)
...
### Für wen eignet sich ClawSpring?
