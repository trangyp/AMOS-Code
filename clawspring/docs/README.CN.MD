...
ClawSpring：**一个轻量级**、**易于使用**、**支持任意模型**的 AI 助手 Python 实现，例如 Claude、GPT、Gemini、Kimi、Qwen、Zhipu、DeepSeek，以及通过 Ollama 或任意 OpenAI-compatible endpoint 使用的本地开源模型。

---

## 目录
  * [为什么选择 ClawSpring](#为什么选择-nano-claude-code)
  * [特性](#特性)
  * [支持的模型](#支持的模型)
  * [安装](#安装)
