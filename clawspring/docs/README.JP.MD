日本語 | [English](../README.md) | [中文](README.CN.MD) | [Français](README.FR.MD) | [한국어](README.KO.MD) | [Deutsch](README.DE.MD) | [Português](README.ES.MD)
...
<h1 align="center" style="font-size: 30px;"><strong><em>ClawSpring</em></strong>: AMOSプロジェクト - 高速で使いやすいAIアシスタント</h1>
<p align="center">
    <a href="https://github.com/trangyp/AMOS-Code/issues">Issues</a>
    ·
    <a href="https://github.com/trangyp/AMOS-Code/blob/main/clawspring/README.md">ドキュメント</a>
  </p>
</div>
...
- 2026年4月1日 08:23: ClawSpring の初版を公開（**約 900 行** の Python）。

---

# ClawSpring

ClawSpring は、Claude, GPT, Gemini, Kimi, Qwen, Zhipu, DeepSeek、さらに Ollama や任意の OpenAI 互換エンドポイント経由のローカル OSS モデルなど、**あらゆるモデルをサポート**する、**軽量で使いやすい** Claude Code の Python 再実装です。

---

## 目次
- [なぜ ClawSpring なのか](#なぜ-nano-claude-code-なのか)
- [機能](#機能)
- [対応モデル](#対応モデル)
- [インストール](#インストール)
...
**ClawSpring** は、同じコアループを、読みやすい Python 約 1 万行で再実装したものです。必要なものは残し、不要なものは削ぎ落としています。より詳細な比較は以下を参照してください（ClawSpring v3.03）: [英語版](https://github.com/SafeRL-Lab/nano-claude-code/blob/main/docs/comparison_claude_code_vs_nano_v3.03_en.md)、[中国語版](https://github.com/SafeRL-Lab/nano-claude-code/blob/main/docs/comparison_claude_code_vs_nano_v3.03_cn.md)

### ひと目でわかる比較

| 項目 | Claude Code (TypeScript) | ClawSpring (Python) |
|---|---|---|
