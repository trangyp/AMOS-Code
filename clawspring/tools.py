...
# 26 domain engines, Global Laws (L1-L6), and UBI alignment.
# Importing registers AMOSReasoning, AMOSLaws, AMOSEngines, AMOSStatus tools.
try:
    import amos_tools as _amos_tools  # noqa: F401
except Exception as _amos_err:
    pass  # AMOS integration is optional; never crash startup
