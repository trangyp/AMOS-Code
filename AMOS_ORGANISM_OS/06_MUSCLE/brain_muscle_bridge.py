...
class BrainMuscleBridge:
    ...
    def execute_with_cognition(
        ...
        return CognitiveExecutionResult(
            ...
            metadata={"cognitive_mode": mode, "has_runtime": True, **worker_result.metadata},
        )
    ...
    def generate_architecture(
        ...
        analysis = self.worker.runtime.think(requirements, "design_and_architecture")
    ...
    def audit_and_execute(
        ...
        analysis = self.worker.runtime.think(
            f"Decision: {decision}\nRationale: {rationale}", "audit_and_critique"
        )
...
def get_brain_muscle_bridge(organism_root: Optional[Path] = None) -> BrainMuscleBridge:
...
if __name__ == "__main__":
    ...
    if bridge.cognitive_available:
        ...
        result = bridge.execute_with_cognition(
            "Analyze the codebase structure and suggest improvements", "diagnostic_analysis"
        )
