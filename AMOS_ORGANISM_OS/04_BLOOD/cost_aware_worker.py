...
from AMOS_ORGANISM_OS.BLOOD.financial_engine import FinancialEngine
from AMOS_ORGANISM_OS.MUSCLE.amos_worker_engine import AmosWorkerEngine, WorkerResult
...
class CostAwareWorker(AmosWorkerEngine):
    ...
    def execute_with_budget(
        self, plan: dict[str, Any], context: dict | None = None, budget_category: str = "compute"
    ) -> WorkerResult:
