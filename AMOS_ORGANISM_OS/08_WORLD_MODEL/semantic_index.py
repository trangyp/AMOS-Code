...
class SemanticIndex:
    ...
    def index_document(self, source: str, content: str,
                       metadata: Dict[str, Any] = None) -> IndexedDocument:
        """Index a document."""
        import hashlib
        import uuid
    ...
    def _tokenize(self, content: str) -> List[str]:
        ...
        stop_words = {"the", "and", "for", "are", "but", "not", "you", "all", "can",
                      ...
                      "two", "way", "who", "boy", "did", "she", "use", "her", "man"}
    ...
    def search(self, query: str, limit: int = 10) -> List[IndexedDocument]:
        ...
        return [self._documents[doc_id] for doc_id in sorted_ids[:limit]
