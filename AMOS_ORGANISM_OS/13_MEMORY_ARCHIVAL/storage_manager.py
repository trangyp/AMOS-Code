...
class StorageManager:
    ...
    def create_backend(self, name: str, storage_type: StorageType,
                       path: str, capacity_bytes: int,
                       config: Optional[Dict[str, Any]] = None) -> StorageBackend:
    ...
    def update_metrics(self, backend_id: str, used_bytes: int,
                       read_ops: float, write_ops: float,
        ...
        backend.metrics.free_bytes = (
            backend.metrics.total_capacity_bytes - used_bytes
        )
    ...
    def list_backends(self, 
                      status_filter: Optional[StorageStatus] = None) -> List[StorageBackend]:
