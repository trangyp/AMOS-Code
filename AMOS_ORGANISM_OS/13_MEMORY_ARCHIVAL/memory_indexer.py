...
class MemoryIndexer:
    ...
    def search_by_tags(self, index_id: str, tags: List[str],
                       match_all: bool = True) -> List[IndexEntry]:
    ...
    def search_by_keywords(self, index_id: str, 
                           keywords: List[str]) -> List[IndexEntry]:
        ...
        keyword_sets = [
            index.keyword_index.get(kw, set()) 
            for kw in keywords
        ]
    ...
    def get_most_accessed(self, index_id: str, 
                          limit: int = 10) -> List[IndexEntry]:
    ...
    def get_recently_accessed(self, index_id: str,
                              limit: int = 10) -> List[IndexEntry]:
        ...
        accessed = [
            e for e in index.entries.values() 
