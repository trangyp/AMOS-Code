...
class MemoryArchiver:
    ...
    def queue_for_archive(self, memory_id: str, content: Dict[str, Any],
    ...
    def get_storage_stats(self) -> Dict[str, Any]:
        ...
        compressed_size = sum(
            a.size_bytes for a in self.archives.values() if a.compressed
        )
    ...
    def cleanup_expired(self) -> int:
        ...
        expired = [
            mid for mid, a in self.archives.items()
            if a.archived_at < cutoff
        ]
