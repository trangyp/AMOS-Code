...
class AMOSState:
    ...
    def get_status(self) -> dict[str, Any]:
        ...
        try:
            from AMOS_ORGANISM_OS.METABOLISM.task_queue import TaskQueue

            task_queue = TaskQueue(self.root / "07_METABOLISM")
            self.tasks_pending = task_queue.get_pending_count()
            self.tasks_running = task_queue.get_running_count()
        except Exception:
            pass
