...
class IntegrationManager:
    ...
    def connect(self, system_id: str) -> bool:
        ...
        try:
            ...
            system.last_connected = datetime.utcnow()
            return True
        except Exception:
    ...
    def receive_data(self, system_id: str) -> Optional[Dict[str, Any]]:
    ...
    def get_events(self, system_id: Optional[str] = None, 
                   unprocessed_only: bool = False) -> List[IntegrationEvent]:
