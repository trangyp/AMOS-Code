...
class BuilderEngine:
    ...
    def execute_task(self, task_id: str) -> Optional[BuildResult]:
...
_BUILDER: Optional[BuilderEngine] = None


def get_builder_engine(organism_root: Optional[Path] = None) -> BuilderEngine:
