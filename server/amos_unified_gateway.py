...
try:
    from amos_agentic_ai import AgentType, AMOSAgent, create_agent
    from amos_brain.facade import BrainClient, BrainResponse
    from amos_cognitive_control_kernel import AMOSCognitiveControlKernel as CognitiveControlKernel
    from amos_cognitive_control_kernel import RuntimeMode
...
class AgentRunRequest(BaseModel):
    ...
    agent_type: str = Field(
        ...,
        pattern="^(code_review|repo_scan|fix_generator|security_audit|performance_check|architect|custom)$",
    )
...
class GatewayState:
    ...
    brain_client: BrainClient = None
    orchestrator: HybridNeuralSymbolicOrchestrator = None
    control_kernel: CognitiveControlKernel = None
...
class BrainIntegration:
    ...
    async def _execute_agent_task(
        self, task_id: str, agent: AMOSAgent, request: AgentRunRequest
    ) -> None:
    ...
    def get_agent_status(self, task_id: str) -> AgentStatusResponse:
    ...
    async def spawn_hybrid_agent(self, role: str, paradigm: Paradigm, task: str) -> dict[str, Any]:
