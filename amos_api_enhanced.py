    ...
    return jsonify({
        'endpoints': {
            ...
            '/query': {
                ...
                'body': {'query': 'string', 'domain': 'optional string', 'limit': 'optional int'},
                'example': {'query': 'scalability', 'limit': 5}
            },
            '/subsystems': {
                'method': 'GET',
                'description': 'List all 14 subsystems'
            },
            '/subsystems/<name>': {
                'method': 'GET',
            ...
            '/countries': {
                'method': 'GET',
                'description': 'List all 55 loaded countries'
            },
            '/countries/<code>': {
                'method': 'GET',
            ...
            '/sectors': {
                'method': 'GET',
                'description': 'List all 19 loaded sectors'
            },
            '/sectors/<code>': {
                'method': 'GET',
                'description': 'Get specific sector details'
            }
        }
    })
