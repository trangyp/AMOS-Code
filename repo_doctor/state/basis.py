...
class StateBasis:
    ...
    WEIGHTS: dict[StateDimension, float] = {
        ...
        StateDimension.LEASE_INTEGRITY: 90.0,
        StateDimension.ZOMBIE_LEASE: 95.0,
        StateDimension.LEASE_CLOCK_COUPLING: 85.0,
        StateDimension.TRANSACTION_SCOPE: 85.0,
        StateDimension.CROSS_PLANE_COMMIT: 90.0,
        StateDimension.COMPENSATION_CLOSURE: 85.0,
        StateDimension.SATURATION_SAFETY: 80.0,
        StateDimension.OVERLOAD_POLICY: 75.0,
        StateDimension.SATURATION_AUTHORITY_DRIFT: 90.0,
        StateDimension.HYSTERESIS_SAFETY: 70.0,
        StateDimension.STATE_MEMORY: 75.0,
        StateDimension.FALSE_SYMMETRY: 80.0,
        StateDimension.SYMMETRY_BREAKING: 75.0,
        StateDimension.TRUST_DOMAIN_INTEGRITY: 95.0,
        StateDimension.TRUST_TRANSITIVITY: 85.0,
        StateDimension.TRUST_CACHE_BLEED: 90.0,
        StateDimension.BUILD_HERMETICITY: 80.0,
        StateDimension.TEST_HERMETICITY: 75.0,
        StateDimension.DOCTOR_HERMETICITY: 85.0,
        StateDimension.IMPOSSIBILITY_AWARENESS: 90.0,
        StateDimension.IMPOSSIBILITY_HONESTY: 85.0,
        StateDimension.DARK_STATE_DETECTABILITY: 80.0,
        StateDimension.NULLSPACE_BEHAVIOR: 75.0,
        StateDimension.NONLOCAL_INVARIANT: 90.0,
        StateDimension.GLOBAL_CONSERVATION: 85.0,
        ...
        StateDimension.LIVENESS: 80.0,
        StateDimension.FAIRNESS: 75.0,
        StateDimension.SCHEDULER_ROBUSTNESS: 80.0,
        StateDimension.PARTITION_BEHAVIOR: 85.0,
        StateDimension.CONVERGENCE: 80.0,
        StateDimension.CAUSAL_ATTRIBUTION: 85.0,
        StateDimension.COMPOSITIONAL_VALIDITY: 90.0,
        StateDimension.OBSERVER_EFFECT_BOUND: 75.0,
        StateDimension.ARCHITECTURAL_ENTROPY: 70.0,
        StateDimension.LOSS_BOUNDEDNESS: 85.0,
        StateDimension.SEMANTIC_LOSS: 80.0,
    ...
    THRESHOLDS: dict[StateDimension, float] = {
        ...
        # Phase 5: Lease, Transaction, and Meta-Stability thresholds
        StateDimension.LEASE_INTEGRITY: 0.90,
        StateDimension.ZOMBIE_LEASE: 0.95,
        StateDimension.LEASE_CLOCK_COUPLING: 0.85,
        StateDimension.TRANSACTION_SCOPE: 0.85,
        StateDimension.CROSS_PLANE_COMMIT: 0.90,
        StateDimension.COMPENSATION_CLOSURE: 0.85,
        StateDimension.SATURATION_SAFETY: 0.80,
        StateDimension.OVERLOAD_POLICY: 0.75,
        StateDimension.SATURATION_AUTHORITY_DRIFT: 0.90,
        StateDimension.HYSTERESIS_SAFETY: 0.70,
        StateDimension.STATE_MEMORY: 0.75,
        StateDimension.FALSE_SYMMETRY: 0.80,
        StateDimension.SYMMETRY_BREAKING: 0.75,
        StateDimension.TRUST_DOMAIN_INTEGRITY: 0.95,
        StateDimension.TRUST_TRANSITIVITY: 0.85,
        StateDimension.TRUST_CACHE_BLEED: 0.90,
        StateDimension.BUILD_HERMETICITY: 0.80,
        StateDimension.TEST_HERMETICITY: 0.75,
        StateDimension.DOCTOR_HERMETICITY: 0.85,
        StateDimension.IMPOSSIBILITY_AWARENESS: 0.90,
        StateDimension.IMPOSSIBILITY_HONESTY: 0.85,
        StateDimension.DARK_STATE_DETECTABILITY: 0.80,
        StateDimension.NULLSPACE_BEHAVIOR: 0.75,
        StateDimension.NONLOCAL_INVARIANT: 0.90,
        StateDimension.GLOBAL_CONSERVATION: 0.85,
        StateDimension.TRUTH_ARBITRATION: 0.95,
        StateDimension.IRREVERSIBILITY_MANAGEMENT: 0.90,
        StateDimension.QUIESCENCE_INTEGRITY: 0.85,
        StateDimension.LIVENESS: 0.80,
        StateDimension.FAIRNESS: 0.75,
        StateDimension.SCHEDULER_ROBUSTNESS: 0.80,
        StateDimension.PARTITION_BEHAVIOR: 0.85,
        StateDimension.CONVERGENCE: 0.80,
        StateDimension.CAUSAL_ATTRIBUTION: 0.85,
        StateDimension.COMPOSITIONAL_VALIDITY: 0.90,
        StateDimension.OBSERVER_EFFECT_BOUND: 0.75,
        StateDimension.ARCHITECTURAL_ENTROPY: 0.70,
        StateDimension.LOSS_BOUNDEDNESS: 0.85,
        StateDimension.SEMANTIC_LOSS: 0.80,
        StateDimension.POLICY_PRECEDENCE: 0.85,
        StateDimension.ADAPTIVE_STABILITY: 0.80,
    }
