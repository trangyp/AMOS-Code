...
class RepoNode:
    ...
    source_location: tuple[Path, int, int] | None = None  # (file, line, col)
...
class RepositoryGraph:
    ...
    def get_node(self, node_id: str) -> RepoNode | None:
        """Get a node by ID."""
    ...
    def find_path(self, source: str, target: str, max_depth: int = 10) -> list[RepoEdge] | None:
