...
class UnifiedIntegrationTestSuite:
    ...
    def run_all_tests(self) -> Dict[str, Any]:
        ...
        self._test_phase("PHASE 1: Unified Launcher", [
        ...
        self._test_phase("PHASE 2: Organism OS (14 Subsystems)", [
        ...
        # Phase 3: Brain Tests
        self._test_phase("PHASE 3: AMOS Brain", [
        ...
        self._test_phase("PHASE 4: Unified Integration", [
        ...
        self._test_phase("PHASE 5: Feature Verification", [
        ...
        for test in tests:
            try:
                ...
                self.results.append(TestResult(
                    test.__name__, False, f"Exception: {str(e)[:50]}"
                ))
    ...
    def _test_all_subsystems_present(self):
        ...
        if not self.organism:
            self.results.append(TestResult("All Subsystems Present", False, "Organism not initialized"))
        ...
        try:
            required_subsystems = [
                ...
                "muscle", "code_runner", "workflow",
                "pipeline", "transform", "io_router",
                "knowledge", "context_mapper", "semantic_index",
                "scenarios", "monte_carlo", "decision_optimizer",
                "agent_coordinator", "communication_bridge", "human_interface", "negotiation_engine",
                "growth_engine", "adaptation_system", "health_monitor", "lifecycle_manager",
                "policy_engine", "compliance_auditor", "contract_manager", "risk_governor",
                "agent_factory", "code_generator", "builder", "quality",
            ]
            ...
            self.results.append(TestResult("All Subsystems Present", True, f"Found {len(required_subsystems)} subsystems"))
    ...
    def _test_organism_status(self):
        ...
        try:
            ...
            self.results.append(TestResult("Organism Status", True, f"{active_count} active subsystems"))
    ...
    def _test_brain_import(self):
        ...
        try:
            from amos_brain import get_brain, GlobalLaws
    ...
    def _test_runtime_initialization(self):
        ...
        if not self.runtime:
            self.results.append(TestResult("Runtime Initialization", False, "Runtime not available"))
    ...
    def _test_subsystem_access(self):
        ...
        if not self.runtime or not self.organism:
            self.results.append(TestResult("Subsystem Access", False, "Runtime/Organism not available"))
        ...
        try:
            ...
            subsystems_to_test = [
                "brain", "health_monitor", "growth_engine",
                "agent_coordinator", "knowledge"
            ]
            ...
            self.results.append(TestResult("Subsystem Access", True, f"{len(accessible)}/{len(subsystems_to_test)} accessible"))
    ...
    def _test_knowledge_catalog(self):
        ...
        try:
            ...
            self.results.append(TestResult("Knowledge Catalog", True, f"{engine_count} engines cataloged"))
    ...
    def _test_health_monitor(self):
        ...
        try:
            ...
            print(f"  ✓ Health monitor: SUCCESS")
        except Exception as e:
    ...
    def _test_adaptation_system(self):
        ...
        try:
            ...
            print(f"  ✓ Adaptation system: SUCCESS")
        except Exception as e:
