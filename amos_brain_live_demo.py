...
def demonstrate_brain_thinking(problem: str):
    ...
    print(f"✓ Memory System: Ready for persistence")
    ...
    if "rule_of_four" in analysis:
        ...
        print(f"🔗 Cross-Impact Analysis: {r4.get('cross_impacts', 'Analyzing interdependencies...')}")
    else:
    ...
    entry_id = memory.save_reasoning(
        problem=problem,
        analysis=analysis,
        tags=["demo", "live_analysis", "rule_of_2", "rule_of_4"]
    )
    ...
    print(f"📈 Recent Brain Activity (Last 7 Days):")
