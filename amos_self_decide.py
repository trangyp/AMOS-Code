...
class AMOSSelfDecider:
    ...
    def decide(self, input_request: str) -> DecisionOutput:
        ...
        print("=" * 70)
        print(f"\nInput: '{input_request}'")
        print(f"System Status: 15 components built, 100% validated")
        print(f"Epistemic Frame: 7 axioms, 4 invariants, 3 constraints")
        print()
    ...
    def _generate_decision(self, p1: Dict, p2: Dict, 
                          quadrants: Dict, axioms: List[str],
                          laws: Dict[str, str]) -> DecisionOutput:
