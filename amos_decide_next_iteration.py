...
components = {
    ...
    'Monitoring': ['amos_health_monitor.py', 'amos_metrics_collector.py', 
                    'amos_alerting.py', 'amos_monitoring_middleware.py', 'templates/monitoring.html'],
    'Examples': ['examples/python_client.py', 'examples/js_client.js', 
