...
class AMOSStateManager:
    ...
    def get_state_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "knowledge": {
                "files_loaded": self.current_state.knowledge_files_loaded
            }
        }
...
def demo_state_manager():
    ...
    print(f"   Tasks: {summary['tasks']['completed']} completed, {summary['tasks']['pending']} pending")
