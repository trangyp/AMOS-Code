...
from repo_doctor.import_analyzer import DependencyGraph, ImportAnalyzer
...
if metrics:
    ...
    for m in sorted_metrics[:5]:
        print(
            f"  {m.module[:50]:50s}: Eff={m.efferent_coupling:2d}, Aff={m.afferent_coupling:2d}, I={m.instability:.2f}"
        )
