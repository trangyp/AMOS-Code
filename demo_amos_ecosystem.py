...
class AMOSEcosystemDemo:
    ...
    def demo_muscle(self) -> dict[str, Any]:
        ...
        result = executor.execute(
            "print('AMOS Muscle executing Python code')",
            ExecutionType.PYTHON
        )
        
        # Execute shell command
        result2 = executor.execute(
            "echo 'AMOS Muscle executing shell'",
            ExecutionType.SHELL
        )
    ...
    def demo_workflow(self) -> dict[str, Any]:
        ...
        analysis = orch.amos.analyze_with_rules(
            "Calculate total system components"
        ) if orch.amos else None
