...
def main():
    ...
    print(f"   HTTP: {config.get('interfaces', 'http_enabled')} (port {config.get('interfaces', 'http_port')})")
    ...
    print(f"   Master Orchestrator: priority={comp_config.priority}, timeout={comp_config.timeout_ms}ms")
