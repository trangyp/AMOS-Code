...
class ImmuneKernel:
    ...
    def check_safety(self, operation: str, context: Dict[str, Any]) -> SafetyReport:
        ...
        safe = (
            not any(t.level in [ThreatLevel.HIGH, ThreatLevel.CRITICAL] for t in threats) and
            not any(a.confidence > 0.8 for a in anomalies)
        )
    ...
    def _log_operation(self, operation: str, context: Dict[str, Any], threats: List[Threat], anomalies: List[Anomaly]):
...
if __name__ == "__main__":
    ...
    report2 = immune.check_safety("execute", {
    ...
    report3 = immune.check_safety("write", {
        "path": "/etc/passwd",
        "data": "test",
        "subsystem": "06_MUSCLE"
    })
