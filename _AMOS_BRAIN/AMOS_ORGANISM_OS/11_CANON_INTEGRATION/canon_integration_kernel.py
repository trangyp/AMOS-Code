...
class CanonIntegrationKernel:
    ...
    def update_service_status(self, service_id: str, status: InterfaceStatus, health_score: Optional[float] = None) -> bool:
...
if __name__ == "__main__":
    ...
    rest_msg = canon.translate_message(
        internal_msg,
        ProtocolType.CUSTOM,
        ProtocolType.REST
    )
