...
class FeatureActivationSystem:
    ...
    def _discover_python_files(self):
        ...
        self.stats['python_files'] = len([f for f in self.discovered.values() 
                                          if f.category in ['organism_subsystem', 'brain_module', 
                                                           'amosl_runtime', 'clawspring_module', 
                                                           'claw_module', 'python_module']])
    ...
    def _discover_json_engines(self):
        ...
        self.stats['json_engines'] = len([f for f in self.discovered.values() 
                                          if f.category == "cognitive_engine"])
    ...
    def _discover_knowledge_files(self):
        ...
        self.stats['knowledge_files'] = len([f for f in self.discovered.values() 
                                             if "knowledge" in f.category or 
                                             f.category == "kernel_spec"])
