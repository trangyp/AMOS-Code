...
class AMOSTestSuite:
    ...
    def _test_v1_core(self):
        ...
        def test_core_import():
            from amos_core import AMOSCore, demo_amos_core
    ...
    def _test_v2_memory(self):
        ...
        def test_memory_import():
            from amos_memory import AMOSMemory, demo_memory_system
    ...
    def _test_v2_meta(self):
        ...
        def test_meta_import():
            from amos_meta import ReflectionEngine, demo_meta_cognition
    ...
    def _test_v3_time(self):
        ...
        def test_time_import():
            from amos_time import TimeEngine, demo_time_engine
    ...
    def _test_v3_energy(self):
        ...
        def test_energy_import():
            from amos_energy import AMOSEnergySystem, demo_energy_system
    ...
    def _test_v4_basic(self):
        ...
        def test_v4_import():
            from amos_v4 import AMOSv4, PersistenceManager, EconomicEngine
    ...
    def _test_v4_production(self):
        ...
        def test_world_model():
            from amos_v4_runtime import WorldModelEngineV4, Signal
        ...
        def test_feedback_compression():
            ...
            feedback = compressor.get_compressed_feedback(action, datetime.utcnow() - datetime.utcnow())
        ...
        def test_production_cycle():
            ...
            goals = [
                {'id': 'test', 'name': 'Test Goal', 'type': 'test', 'expected_value': 100,
                 'resource_cost': {'time': 10}, 'risk_score': 0.1}
            ]
    ...
    def _test_v5(self):
        ...
        def test_political_intelligence():
            from amos_v5 import PoliticalIntelligence, InstitutionalActor
    ...
    def _test_connectors(self):
        ...
        def test_execution_manager():
            from amos_connectors import ExecutionManager, ExecutionHook
            em = ExecutionManager()
...
def main():
    ...
    parser.add_argument('--quick', '-q', action='store_true', 
                       help='Run quick tests only (skip v5, connectors)')
