...
class SystemDiagnostics:
    ...
    COMPONENTS = [
        ...
        "amosl_ledger", "amosl_verification", "amosl_bridge",
        "amosl_evolution", "amosl_kernel", "amosl_axioms", "amosl_admissibility",
        
        # Feature Ecosystem (2)
        "amos_feature_activation", "amos_primary_feature_handler",
        
        # Knowledge & Engines (3)
        "amos_knowledge_loader", "amos_engine_activator", "amos_cognitive_router",
        
        # Master Orchestration (2)
        "amos_master_cognitive_orchestrator", "amos_organism_integration_bridge",
        
        # Integration (1)
        "amos_integration_test",
        
        # Demos (4)
        "amos_comprehensive_demo", "amos_quickstart_demo", 
        "amos_organism_bridge_demo", "amos_unified_execution_engine",
        
        # Interfaces (4)
        "amos_cli_simple", "amos_http_api", "amos_dashboard", "amos_brain_ui",
        
        # Infrastructure (43+)
        "amos_core", "amos_brain", "amos_decision", "amos_orchestrator",
        "amos_integrated_workflow", "amos_organism_orchestrator",
        "amos_axiom_validator", "amos_cognitive_runtime",
        "amos_coherence_engine", "amos_coherence_omega",
        "amos_coherent_organism", "amos_health_monitor",
        "amos_muscle_executor", "amos_connectors",
        "amos_cognitive_agent", "amos_autonomous_agent",
        "amos_api_enhanced", "amos_api_simple", "amos_api_server",
        "amos_brain_cli", "amos_brain_launcher",
        "amos_cleanup_analyzer", "amos_creative_reasoning",
        "amos_database", "amos_brain_organism_bridge",
        "amos_dashboard_enhanced", "amos_economic_engine",
        "amos_economic_organism", "amos_field_theory",
        "amos_final_comprehensive_demo", "amos_final_demo",
        "amos_eight_layer_demo", "amos_activate_self_driving",
        "amos_agent_bridge", "amos_alerting", "amos_brain_complete_ui",
        "amos_brain_enhanced_ui", "amos_brain_live_demo",
        "amos_brain_tutorial", "amos_brain_unified_ui",
        "amos_decide_next_build", "amos_decide_next_iteration",
        "amos_clawspring", "amos_state"
    ]
    ...
    def _check_component(self, name: str) -> ComponentCheck:
        ...
        try:
            ...
            has_main = hasattr(module, 'main') and callable(getattr(module, 'main'))
