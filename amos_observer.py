...
class AMOSObserver:
    ...
    def trace_thought(self, problem: str) -> dict[str, Any]:
        ...
        if reasoning:
            ...
            print(f"  Rule of 2: {analysis.get('rule_of_two', {}).get('confidence', 'N/A')} confidence")
            print(f"  Rule of 4: {len(analysis.get('rule_of_four', {}).get('quadrants', {}))} quadrants")
...
def main():
    parser = argparse.ArgumentParser(
        description="AMOS Brain Observer"
    )
    parser.add_argument(
        'command',
        nargs='?',
