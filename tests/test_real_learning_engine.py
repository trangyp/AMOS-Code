...
def test_learn_from_successful_task():
    ...
    from amos_brain.real_learning_engine import RealLearningEngine, learn_from_task
...
def test_pattern_detection():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        pattern = engine.pattern_detector.detect_pattern(
            "Need to fix import error in repo_doctor module", {"error_type": "import"}
        )
...
def test_procedure_reuse():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        result = attempt_procedure_reuse(
            "Fix import error for missing repo_doctor module", {"error_type": "import"}
        )
