...
class CodeParser:
    ...
    def _parse_class(self, node: ast.ClassDef, file_path: Path, content: str, module: str):
        ...
        entity = CodeEntity(
            ...
            content=content[node.lineno-1:node.end_lineno] if hasattr(node, 'end_lineno') else "",
            dependencies=bases,
...
class ZoneClassifier:
    ...
    ZONE_DEFINITIONS = {
        'skeleton': {
            ...
            'patterns': ['abstract', 'base', 'interface', 'contract', 'law', 'type', 'schema', 'config'],
        ...
        'immune': {
            ...
            'patterns': ['validate', 'check', 'verify', 'detect', 'guard', 'protect', 'sanitize', 'immune']
        },
        'motor': {
