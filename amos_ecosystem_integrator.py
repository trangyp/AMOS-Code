...
class Ecosystem:
    ...
    def activate(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self.state.session_id = sm.start_session(
                goal="Ecosystem Activation",
                domain="unified"
            )
        ...
        try:
            ...
            results["components"]["amosl"] = {
                "status": "available",
                "version": amosl_version
            }
        except Exception as e:
        ...
        active_count = sum(1 for c in results["components"].values() 
    ...
    def status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "components": {
                ...
                "amosl": {
                    "loaded": self.state.amosl_loaded
                },
                "sdk": {
                    "available": self.state.sdk_available
                },
                "clawspring": {
                    "connected": self.state.clawspring_connected
                }
            }
        }
