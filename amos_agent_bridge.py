...
class AMOSAgentBridge:
    ...
    def design_architecture(self, requirements: str, constraints: List[str] = None) -> Dict[str, Any]:
        """
        ...
        if not ubi_check["aligned"]:
            arch_recommendations.append(
                "Review design for UBI alignment - may impact human users"
            )
    ...
    def audit_decision(self, decision: str, rationale: str) -> Dict[str, Any]:
        ...
        rule2_check = meta.check_rule_of_2(
            decision, 
            ["alternative approach", "opposing view"]
        )
