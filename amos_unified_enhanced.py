...
class AMOSUnifiedEnhanced:
    ...
    def _init_knowledge(self):
        ...
        try:
            from amos_brain.knowledge_loader import (
                KnowledgeEnhancedBrain,
            ...
            print(f"   System will operate without knowledge base")
...
def demo_enhanced_system():
    ...
    print(f"Problem: 'Best architecture for scalability?'")
    print(f"Knowledge entries used: {result.get('knowledge_used', 0)}")
    print(f"Status: Knowledge-enhanced reasoning ✓")
    ...
    print(f"Brain: 6 global laws")
    print(f"Knowledge: {amos.status.knowledge_entries:,} entries")
    print(f"Integration: Fully unified ✓")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="AMOS Unified Enhanced - Fully Integrated System"
    )
    parser.add_argument(
        "--demo", 
        action="store_true",
