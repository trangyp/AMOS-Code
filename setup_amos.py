...
def check_python_path():
    ...
    if str(amos_root) in sys.path:
        ...
        warn(f"AMOS root NOT in sys.path")
...
def check_amos_brain():
    ...
    try:
        from amos_brain import get_brain, get_amos_integration
...
def print_next_steps():
    ...
    print(f"    {C.GREEN}python -c 'from amos_brain import get_amos_integration; print(get_amos_integration().get_status())'{C.RESET}")
    print()
