...
def demo_brain_integration():
    ...
    try:
        from amos_brain import get_brain, GlobalLaws, think, decide
...
def generate_summary(org):
    ...
    print(f"\n  Next Steps:")
    print(f"     • Run validation: python test_unified_integration.py")
    print(f"     • Use launcher: python amos_unified_launcher.py")
    print(f"     • Start coding: Access any subsystem via organism")
    print()
    print("█" * 70)
