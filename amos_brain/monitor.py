...
class CognitiveMonitor:
    ...
    def get_metrics_summary(self, window_seconds: int = 3600) -> dict:
        ...
        return {
            ...
            "reasoning": {
                ...
                "avg_time_ms": sum(reasoning_times) / len(reasoning_times) if reasoning_times else 0,
    ...
    def get_law_compliance_dashboard(self) -> dict:
        ...
        for law_id in ["L1", "L2", "L3", "L4", "L5", "L6"]:
            ...
            if law:
                ...
                law_metrics = [m for m in self._metrics 
    ...
    def detect_anomalies(self) -> list[dict]:
        ...
        recent_times = [m.value for m in self._metrics[-20:] 
                       if m.metric_type == "reasoning_time_ms"]
        ...
        recent_violations = [m.value for m in self._metrics[-20:]
                            if m.metric_type == "law_violations"]
    ...
    def export_audit_log(self, filepath: Path | None = None) -> Path:
