...
class MultiAgentOrchestrator:
    ...
    def spawn_agent(
        self, name: str, domain: str, capabilities: Optional[list[str]] = None
    ) -> Agent:
    ...
    def orchestrate(
        self, task: str, agents: Optional[list[Agent]] = None, mode: str = "parallel"
    ) -> OrchestrationResult:
    ...
    def _build_consensus(self, results: list[dict[str, Any]]) -> Optional[str]:
...
def spawn_agent(name: str, domain: str, capabilities: Optional[list[str]] = None) -> Agent:
    """Quick agent spawn."""
    return get_multi_agent_orchestrator().spawn_agent(name, domain, capabilities)


def orchestrate_task(task: str, agents: Optional[list[Agent]] = None) -> OrchestrationResult:
