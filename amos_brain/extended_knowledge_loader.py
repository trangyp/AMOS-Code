...
class ExtendedKnowledgeLoader:
    ...
    def load_all(self, base_path: Optional[Path] = None) -> Dict[str, Any]:
        ...
        print(f"✅ Extended knowledge loaded!")
    ...
    def query_countries(self, query: str = None, limit: int = 10) -> List[CountryKnowledge]:
        ...
        for country in self.countries.values():
            if not query:
                ...
                if (query_lower in country.country_code.lower() or
                    query_lower in country.country_name.lower() or
                    any(query_lower in tag.lower() for tag in country.tags)):
                    results.append(country)
        
        return results[:limit]
    
    def query_sectors(self, query: str = None, domain: str = None, limit: int = 10) -> List[SectorKnowledge]:
        ...
        for sector in self.sectors.values():
            ...
            if not query:
                ...
                # Match by name, code, or tags
                if (query_lower in sector.sector_code.lower() or
                    query_lower in sector.sector_name.lower() or
                    any(query_lower in tag.lower() for tag in sector.tags)):
                    results.append(sector)
...
class ComprehensiveKnowledgeSystem:
    ...
    def initialize(self, core_loader=None) -> Dict[str, Any]:
        ...
        print(f"✅ Comprehensive knowledge system ready!")
        print(f"   Core knowledge: Brain_Master (17.8MB)")
