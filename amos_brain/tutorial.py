...
Usage:
  amos-tutorial  # Entry point after pip install
  python -m amos_brain.tutorial
"""
...
def demo_decide(amos, memory):
    ...
    lesson(
        "Key Takeaway",
        "Use `amos-cli decide <problem>` whenever you need structured analysis.\n"
...
def demo_analyze(amos, memory):
    ...
    lesson(
        "Key Takeaway",
        "Use `amos-cli analyze <topic>` for deep systems understanding.\n"
...
def demo_laws():
    ...
    lesson(
        ...
        "Use `amos-cli audit --text ...` to validate text against the laws.",
    )
...
def demo_practical_exercises(amos, memory):
    ...
    lesson(
        ...
        "  python -m clawspring.clawspring --amos\n\n"
...
def main():
    ...
    print(clr("═" * 60, "green"))
    print()
    print("Next: Run amos-cli to practice")
    print()
