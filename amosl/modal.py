...
class ModalLogic:
    ...
    def necessity(self, predicate: Callable[[Any], StratifiedTruth],
                  domain: List[Any]) -> StratifiedTruth:
        """
    ...
    def possibility(self, predicate: Callable[[Any], StratifiedTruth],
                   domain: List[Any]) -> StratifiedTruth:
        """
    ...
    def observational_modality(self, predicate: StratifiedTruth,
                              measurement: str,
                              post_state: Any) -> StratifiedTruth:
        """
    ...
    def evolution_modality(self, predicate: StratifiedTruth,
                          refinement_level: int) -> StratifiedTruth:
        """
    ...
    def implies(self, antecedent: StratifiedTruth,
               consequent: StratifiedTruth) -> StratifiedTruth:
    ...
    def not_op(self, operand: StratifiedTruth) -> StratifiedTruth:
        ...
        return StratifiedTruth(
            TruthValue.PROBABILISTIC,
            probability=1.0 - operand.confidence()
        )
    ...
    def contextual_truth(self, base_truth: StratifiedTruth,
                        context: str) -> StratifiedTruth:
...
class AdmissibilityLogic:
    ...
    def necessity_of_commitment(self, state: Any,
                                future_states: List[Any]) -> StratifiedTruth:
        """
    ...
    def possibility_of_explanation(self, ledger: List[Any],
                                  outcome: Any) -> StratifiedTruth:
        """
