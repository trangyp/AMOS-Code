...
class InformationGeometry:
    ...
    def distance_on_manifold(self, belief1: BeliefState, belief2: BeliefState) -> float:
        ...
        """
        return math.sqrt(
            self.kl_divergence(belief1, belief2) + self.kl_divergence(belief2, belief1)
        )
...
class BeliefManifold:
    ...
    def update(self, observation: str, likelihood: Dict[str, float]) -> BeliefState:
        ...
        new_belief = self.geometry.bayesian_update(self.current_belief, likelihood, observation)
