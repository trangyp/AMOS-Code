...
class BridgeExecutor:
    ...
    def check_legality(self, bridge_type: BridgeType,
                       type_compat: bool = True,
                       unit_compat: bool = True,
                       time_compat: bool = True,
                       obs_compat: bool = True,
                       error_compat: bool = True) -> Tuple[bool, str]:
        """Check Legal(B_{ij})."""
        checks = {
    ...
    def execute_classical_to_quantum(self, classical_value: Any,
                                      qubit_index: int = 0) -> Dict[str, Any]:
        ...
        if classical_value == 0:
            ...
            qubit_state = {"basis": "superposition", "value": f"α|0⟩+β|1⟩"}
    ...
    def execute_quantum_to_classical(self, measurement_result: Any,
                                      basis: str = "computational") -> Dict[str, Any]:
    ...
    def execute_classical_to_biological(self, control_signal: float,
    ...
    def execute_biological_to_classical(self, expression_level: float,
                                       threshold: float = 0.5) -> Dict[str, Any]:
    ...
    def execute(self, bridge_type: BridgeType, value: Any, **kwargs) -> Dict[str, Any]:
        ...
        dispatch = {
            BridgeType.C_TO_Q: lambda: self.execute_classical_to_quantum(value, kwargs.get("qubit", 0)),
            BridgeType.Q_TO_C: lambda: self.execute_quantum_to_classical(value, kwargs.get("basis", "computational")),
            BridgeType.C_TO_B: lambda: self.execute_classical_to_biological(value, kwargs.get("threshold", 0.5)),
            BridgeType.B_TO_C: lambda: self.execute_biological_to_classical(value, kwargs.get("threshold", 0.5)),
