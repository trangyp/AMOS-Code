    ...
    def get_organism_subsystems(self) -> dict[str, Any]:
        ...
        return {
            ...
            "01_BRAIN": {
                ...
                "role": "Decision",
                "engines": ["CognitiveStack", "ReasoningEngine", "BrainLoader"],
            },
            "02_SENSES": {
                "name": "Environmental Senses",
                "role": "Input",
                "engines": ["ContextGatherer", "EnvironmentScanner"],
            },
            "03_IMMUNE": {
                "name": "Immune System",
                "role": "Protection",
                "engines": ["AnomalyDetector", "ComplianceEngine"],
            },
            "04_BLOOD": {
            ...
            "07_METABOLISM": {
                "name": "Metabolism",
                "role": "Processing",
                "engines": ["CleanupEngine", "PipelineEngine", "TransformEngine"],
            },
            "08_WORLD_MODEL": {
                "name": "World Model",
                "role": "Environment",
                "engines": ["WorldModelEngine", "StateManager"],
            },
            "09_SOCIAL_ENGINE": {
                "name": "Social Engine",
                "role": "Coordination",
                "engines": ["SocialEngine", "NegotiationEngine", "MultiAgent"],
            },
            "10_LIFE_ENGINE": {
                "name": "Life Engine",
                "role": "Growth",
                "engines": ["LifeEngine", "BioRhythmEngine", "GrowthEngine"],
            },
            "11_LEGAL_BRAIN": {
                "name": "Legal Brain",
                "role": "Compliance",
                "engines": ["LegalEngine", "PolicyEngine", "EthicsEngine"],
            },
            "12_QUANTUM_LAYER": {
                "name": "Quantum Layer",
                "role": "Decisions",
            ...
            "13_FACTORY": {
                "name": "Factory",
                "role": "Building",
                "engines": ["BuilderEngine", "ConstructionEngine"],
            },
            "14_INTERFACES": {
                "name": "Interfaces",
                "role": "I/O",
                "engines": ["DashboardServer", "APIServer", "CLIManager"],
            },
            "99_ARCHIVE": {
                "name": "Archive",
                "role": "Storage",
                "engines": ["ArchiveEngine", "HistoryManager"],
            },
        }
    ...
    def get_integrations(self) -> dict[str, Any]:
        ...
        return {
            "ClawSpring_Agent_Bridge": {
                "type": "realtime",
                "hooks": ["pre_tool", "post_tool", "memory"],
            },
            "Primary_Loop": {
                "type": "orchestration",
                "flow": "BRAIN→SENSES→SKELETON→WORLD→QUANTUM→MUSCLE→METABOLISM",
            },
            "Unified_CLI": {
                "type": "interface",
            ...
            "Coherent_Organism": {
                "type": "validation",
                "phases": ["pre_check", "execution", "post_check"],
            },
            "AMOS_API": {
                "type": "service",
                "endpoints": ["status", "analyze", "decide", "health", "workflow"],
            },
            "Self_Driving_Loop": {
                "type": "autonomous",
                "features": ["self_analyze", "decide", "build", "iterate"],
            },
            "Health_Monitor": {
                "type": "monitoring",
                "features": ["watch_mode", "coherence_check", "metrics"],
            },
        }
